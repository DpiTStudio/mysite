...
CAPTCHA_CHALLENGE_FUNCT = (
    "captcha.helpers.random_char_challenge"  # Функция для генерации капчи
)
CAPTCHA_LENGTH = 3
CAPTCHA_TIMEOUT = 5
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "services.ServiceCategory": "fas fa-folder",
        "services.ServiceStep": "fas fa-list-ol",
        "services.ServiceBenefit": "fas fa-award",
        "services.ServiceFAQ": "fas fa-question-circle",
        "services.ServicePricePlan": "fas fa-tags",
        "services.PricePlanFeature": "fas fa-check-double",
        "services.ServiceOrder": "fas fa-file-invoice-dollar",
        "services.Technology": "fas fa-microchip",
        "services.Deliverable": "fas fa-box-open",
        ...
        "cart.PromoCode": "fas fa-percent",
        "cart.PromoCodeUsage": "fas fa-ticket-alt",
...
SECURE_HSTS_SECONDS = (
    31536000 if not DEBUG and SECURE_SSL_REDIRECT else 0
)  # Безопасность HSTS
